                ...
                $.each(contributor, function(index) {
                    ...
                    if (!uniqueuser.has(contributor[index].login)) {
                        ...
                        var uobj = {
                            ...
                            imgurl: contributor[index].avatar_url
                        };
...
function bcrousel() {
    ...
    $('#contibutorslist2').html(outhtmlb + '</div></div> <a class="carousel-control-prev" href="#carouselExampleControls1" role="button" data-slide="prev" style="width:3%"><i class="fa fa-angle-left angle" aria-hidden="true" style="font-size:3em;color:#ff9933"></i></a><a class="carousel-control-next" href="#carouselExampleControls1" role="button" data-slide="next" style="width:3%"><i class="fa fa-angle-right" aria-hidden="true" style="font-size:3em;color:#ff9933"></i></a></div>');
}
